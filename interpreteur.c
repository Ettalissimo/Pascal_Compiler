...
void lire_instruction(){
    ...
    if (STRCASECMP(mot, "LDA") == 0) {
        ECRIRE2(LDA, nombre);
    } else if (STRCASECMP(mot, "LDI") == 0) {
        ECRIRE2(LDI, nombre);
    } else if (STRCASECMP(mot, "INT") == 0) {
        ECRIRE2(INT, nombre);
    } else if (STRCASECMP(mot, "BZE") == 0) {
        ECRIRE2(BZE, nombre);
    } else if (STRCASECMP(mot, "BRN") == 0) {
        ECRIRE2(BRN, nombre);
    } else if (STRCASECMP(mot, "LDV") == 0) {
        ECRIRE1(LDV);
    } else if (STRCASECMP(mot, "ADD") == 0) {
        ECRIRE1(ADD);
    } else if (STRCASECMP(mot, "SUB") == 0) {
        ECRIRE1(SUB);
    } else if (STRCASECMP(mot, "MUL") == 0) {
        ECRIRE1(MUL);
    } else if (STRCASECMP(mot, "DIV") == 0) {
        ECRIRE1(DIV);
    } else if (STRCASECMP(mot, "LEQ") == 0) {
        ECRIRE1(LEQ);
    } else if (STRCASECMP(mot, "GEQ") == 0) {
        ECRIRE1(GEQ);
    } else if (STRCASECMP(mot, "NEQ") == 0) {
        ECRIRE1(NEQ);
    } else if (STRCASECMP(mot, "LSS") == 0) {
        ECRIRE1(LSS);
    } else if (STRCASECMP(mot, "GTR") == 0) {
        ECRIRE1(GTR);
    } else if (STRCASECMP(mot, "HLT") == 0) {
        ECRIRE1(HLT);
    } else if (STRCASECMP(mot, "STO") == 0) {
        ECRIRE1(STO);
    } else if (STRCASECMP(mot, "INN") == 0) {
        ECRIRE1(INN);
    } else if (STRCASECMP(mot, "PRN") == 0) {
        ECRIRE1(PRN);
    } else {
        printf("%s\n",mot);
